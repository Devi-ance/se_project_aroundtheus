...
function openPreview() {
  previewModal.classList.add("preview-modal_open");
}

function closePreview() {
  previewModal.classList.remove("preview-modal_open");
}
